...
const PurchasePage = () => {
  ...
  const standInfo = {
    Mini: "Portable mini desk stand",
    Standard: "Adjustable home & office stand",
    Premium: "Heavy-duty professional stand",
  };

  const product = {
    name: "MAC Adjustable Mobile Stand",
    category: "Mobile Accessories",
    rating: 4.7,
    colors: ["Black", "Silver", "Blue", "Red", "Rose Gold"],
    sizes: Object.keys(priceList),
    images: [
      "/Images/products/mobilestand/1.png",
      "/Images/products/mobilestand/7.jpeg",
      "/Images/products/mobilestand/3.png",
      "/Images/products/mobilestand/4.png",
      "/Images/products/mobilestand/5.png",
      "/Images/products/mobilestand/6.png",
    ],
    description: [
      "Strong powder-coated metal body",
      "Adjustable angle and foldable design",
      "Anti-slip rubber base",
      "Suitable for mobile & tablet devices",
      "Perfect for office, home & online classes",
      ...
      <div className="flex flex-col md:flex-row gap-6 mt-4">
        ...
        <div className="flex-1 md:ml-17">
          ...
          <div className="flex items-center gap-1 mt-1">
            ...
            <p className="text-xs text-gray-600 ml-1">({product.rating} / 5)</p>
          </div>
            ...
            <div className="flex gap-2 flex-wrap">
              {product.colors.map((color) => (
                <button
                  ...
                  className={`border px-5 mr-3 py-1.5 rounded-md text-xs ${
                    selectedColor === color
          ...
          {/* Size Options */}
          <div className="mt-4">
            <p className="font-medium mb-1 text-sm">Select Model:</p>
            <div className="flex gap-2 flex-wrap">
              {product.sizes.map((size) => (
                <button
                  key={size}
                  onClick={() => setSelectedSize(size)}
                  className={`border mr-3 px-5 py-1.5 rounded-md text-xs ${
                    selectedSize === size
                      ? "border-red-600 bg-red-50 text-red-600"
                      : "border-gray-300 hover:bg-gray-100"
                  }`}
